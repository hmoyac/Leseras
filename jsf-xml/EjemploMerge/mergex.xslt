...
<xslt:transform version="1.0"
		    ...
		    xmlns:util="com.siss.utilxml.NodeSet">
...
<xslt:template match="m:merge" >
   ...
   <xslt:message>
      <xslt:text />Fusionando '<xslt:value-of select="$file1" />
      <xslt:text />' y '<xslt:value-of select="$file2"/>'<xslt:text />
   </xslt:message>
   ...
   <xslt:call-template name="m:merge">
      <xslt:with-param name="nodes1" select="util:getNS1()/node()" />
      <xslt:with-param name="nodes2" select="util:getNS2()/node()" />
   </xslt:call-template>
</xslt:template>
